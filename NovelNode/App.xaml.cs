...
using NovelNode.Views.UserControls;
    ...
    public partial class App
    {
        ...
        private static readonly IHost _host = Host
            ...
            .ConfigureServices((context, services) =>
            {
                ...
                services.AddSingleton<PlayerViewViewModel>();
        ...
        private async void OnStartup(object sender, StartupEventArgs e)
        {
            ...
            GetService<MainWindowViewModel>().OnStartup();
            Extensions.LoadData();

            Log.Logger = new LoggerConfiguration()
                .MinimumLevel.Verbose().WriteTo
                .File("NovelNode_Handler.log")
                .CreateLogger();
        }
        ...
        {
            Extensions.Notify("Core", $"Unhandled Exception: {e.Exception.Message}");
        }
    }
}
